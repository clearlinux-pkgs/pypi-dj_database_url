...
Version  : 2.3.0
Release  : 47
URL      : https://files.pythonhosted.org/packages/98/9f/fc9905758256af4f68a55da94ab78a13e7775074edfdcaddd757d4921686/dj_database_url-2.3.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/98/9f/fc9905758256af4f68a55da94ab78a13e7775074edfdcaddd757d4921686/dj_database_url-2.3.0.tar.gz
...
%prep
%setup -q -n dj_database_url-2.3.0
cd %{_builddir}/dj_database_url-2.3.0
pushd ..
cp -a dj_database_url-2.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729692985
...
cp %{_builddir}/dj_database_url-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-dj_database_url/77728a126517af7d601bac9cd4c8f69556b7e3da || :
